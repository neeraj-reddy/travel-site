...
var mobileNav = new _mobileMenu2.default();
...
var stickyHeader = function () {
    ...
    _createClass(stickyHeader, [{
        ...
        value: function createheaderWaypoint() {
            var headerAlterTrigger = this;
            new Waypoint({
                element: this.headerTriggerElement[0],
                handler: function handler(direction) {
                    if (direction == "down") {
                        headerAlterTrigger.siteHeader.addClass("site-header--dark");
                    } else {
                        headerAlterTrigger.siteHeader.removeClass("site-header--dark");
                    }
                }
            });
        }
        ...
        value: function createPageSectionWaypoints() {
            ...
            this.pageSections.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == "down") {
                            var sectionLinkHighlight = currentPageSection.getAttribute("data-link-highlight");
                            that.headerLinks.removeClass("is-current-link");
                            (0, _jquery2.default)(sectionLinkHighlight).addClass("is-current-link");
                        }
                    },
                    offset: "18%"
                });
